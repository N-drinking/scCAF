...
parser = argparse.ArgumentParser(description='scCAF', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('--lambda3', type=float, default=25)
